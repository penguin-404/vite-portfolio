...
export default function Contact() {
  return (
    <div className="relative flex items-top justify-center min-h-[560px] bg-white dark:bg-gray-800 sm:items-center sm:pt-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-900 sm:rounded-lg">
              ...
              <div className="flex items-center mt-8 text-gray-600 dark:text-gray-300">
                <svg
                  className="w-8 h-8 text-gray-500 dark:text-orange-400"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
