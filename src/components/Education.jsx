...
export default function Education() {
  return (
    <div className="h-[75vh] bg-gray-800 text-white px-6 py-12 flex items-center justify-center">
        ...
        <div className="space-y-10 text-lg text-justify">
          <div>
            <h2 className="text-xl font-semibold text-white mb-1">
              ...
              <span className="block text-sm text-gray-400">2025</span>
            </h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-1">
              ...
              <span className="block text-sm text-gray-400">2020</span>
            </h2>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
