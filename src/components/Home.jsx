    ...
    <>
      <div className="h-[75vh] flex items-center justify-center bg-white dark:bg-gray-800 text-black dark:text-white px-6">
        <ul className="list-none space-y-7 text-xl lg:text-2xl text-justify max-w-xl">
          ...
          <li className="before:content-['-'] before:mr-2">
            Crafting interfaces with <span className="font-semibold text-orange-400">React</span>.
          </li>
          <li className="before:content-['-'] before:mr-2">
            <span className="font-semibold text-orange-400">Next.js</span> developer by day, debugger by night.
          </li>
          <li className="before:content-['-'] before:mr-2">
             Running <span className="font-semibold text-orange-400">Linux</span>, writing JavaScript — loving both.
          </li>
